<nav class="navbar navbar-expand-md navbar-light fixed-top bg-light">
	<div class="container">
		...
		<a class="navbar-brand" href="<?= base_url() ?>">TOKO ABC</a>
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item dropdown">
					<a href="#" class="nav-link dropdown-toggle" id="dropdown-1" , data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Manage (Admin Only)</a>
			...
			<ul class="navbar-nav">
				<li class="nav-item">
					<a href="<?= base_url('cart') ?>" class="nav-link"><i class="fas fa-shopping-cart"></i> Keranjang Belanja(<?= getCart() ?>)</a>
				</li>
