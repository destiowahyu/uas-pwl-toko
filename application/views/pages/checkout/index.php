                ...
                <div class="card-body">
                    <form action="<?= base_url('checkout/create') ?>" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="address" cols="30" rows="5" placeholder="Tulis Alamat Lengkap Penerima" class="form-control"><?= $input->address ?></textarea>
                            <?= form_error('address') ?>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="pembayaran" class="form-control" name="test">
